...
def plant_growth():
    ...
    Fillter = care_data[care_data["Plant Name"] == selected_plant].copy()

    Fillter["Date"] = pd.to_datetime(Fillter["Date"], format="mixed")
    Fillter["Height"] = pd.to_numeric(Fillter["Height"])
